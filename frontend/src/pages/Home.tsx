        ...
        <div className="flex justify-center items-center h-full mt-16 lg:mt-40">
            <div className="home-section-container flex flex-col lg:flex-row lg:justify-around items-center w-full max-w-5xl px-4">
                <section className="text-center prose w-80 max-w-full">
                    <h1>Who will <span className="italic text-accent">you</span> become?</h1>
                    ...
                    {user ? <></> :
                        <section className="home-login-button py-4">
                            <button className="btn btn-primary btn-lg font-serif text-white" onClick={() => navigate("/login")}>Login</button>
                        </section>}
                </section>
                <section className="text-center prose w-80 max-w-full mt-16 lg:mt-0">
                    <div>
                        ...
                        <div><Link className="no-underline hover:text-accent" to={user ? "/dashboard" : "/local-dashboard"}><h2 className="text-[170%] hover:text-accent transition-all duration-600">My Characters</h2></Link></div>
                    </div>
                </section>
            </div>
